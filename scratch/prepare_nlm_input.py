...
output_path = "/Users/yuan/Projects/Exam/Exam_prepare_site/scratch/antigbm_nlm_input.json"
with open(output_path, "w", encoding="utf-8") as f:
    json.dump(questions_list, f, ensure_ascii=False, indent=2)

print(f"Prepared NLM input JSON with {len(questions_list)} questions at {output_path}")
